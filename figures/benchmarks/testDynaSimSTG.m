...
equations = {...
  ...
  'iCaT(v,mCaT,hCaT,Ca)=gCaT.*mCaT.^3.*hCaT.*(v-120)',...
  'iCaS(v,mCaS,hCaS,Ca)=gCaS.*mCaS.^3.*hCaS.*(v-120)',...
  ...
  'dmKCa/dt=(minfKCa(v,Ca)-mKCa)./taumKCa(v)',...
  'dmKd/dt=(minfKd(v)-mKd)./taumKd(v)',...
  'dmH/dt=(minfH(v)-mH)./taumH(v)',...
  'dCa/dt=(0.05-1.496*0.0628*(iCaT(v,mCaT,hCaT,Ca)+iCaS(v,mCaS,hCaS,Ca))-Ca)./200',...
