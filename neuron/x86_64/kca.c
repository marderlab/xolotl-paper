...
#define taum taum_kca
 extern double minf( _threadargsprotocomma_ double , double );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /home/alec/code/xolotl-paper/neuron/x86_64/kca.mod\n");
...
static void _hoc_minf(void) {
  ...
  _nt = nrn_threads;
 _r =  minf ( _p, _ppvar, _thread, _nt, *getarg(1) , *getarg(2) );
 hoc_retpushx(_r);
}
 
double taum ( _threadargsprotocomma_ double _lVm ) {
   double _ltaum;
  _ltaum = 90.3 - 75.1 / ( 1.0 + exp ( ( _lVm + 46.0 ) / - 22.7 ) ) ;
...
static int  rates ( _threadargsprotocomma_ double _lVm , double _lcai ) {
   m_inf = minf ( _threadargscomma_ _lVm , _lcai ) ;
