...
#define settables settables__NaV 
#define states states__NaV 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaV /home/marder/code/simulation-environment-paper/neuron/x86_64/NaV.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "fast inactivating sodium conductance";
...
static int  settables ( _threadargsprotocomma_ double _lv ) {
   ...
   taum = 1.32 - 1.26 / ( 1.0 + exp ( ( _lv + 120.0 ) / ( - 25.0 ) ) ) ;
   tauh = ( 0.67 / ( 1.0 + exp ( ( _lv + 62.9 ) / ( - 10.0 ) ) ) ) * ( 1.5 + 1.0 / ( 1.0 + exp ( ( _lv + 34.9 ) / 3.6 ) ) ) ;
    return 0; }
