...
#define settables settables__Kd 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kd /home/marder/code/simulation-environment-paper/neuron/x86_64/Kd.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "delayed rectifier";
...
static int  settables ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( - ( _lv + 12.3 ) / 11.8 ) ) ;
   taum = 7.2 - 6.4 / ( 1.0 + exp ( - ( _lv + 28.3 ) / 19.2 ) ) ;
   minf = 1.0 ;
   taum = 1.0 ;
    return 0; }
