...
#define gbar	*_ppvar[1]._pval
#define _p_gbar	_ppvar[1]._pval
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /home/alec/code/xolotl-paper/neuron/morse-model/x86_64/kca.mod\n");
...
static int  rates (  double _lVm ) {
   tau_m = taum ( _threadargscomma_ _lVm ) ;
    minf = ( cai / ( cai + 3e-3 ) ) * ( 1.0 / ( 1.0 + exp ( - ( _lVm + 28.3 ) / 12.6 ) ) ) ;
     return 0; }
